...
function Galactic_Planet_Faction_Change(planet, newplayer, oldplayer)
	...
	GameScoringMessage("GameScoring -- %s changed control from %s to %s.", planet_type.Get_Name(), oldplayer.Get_Name(), newplayer.Get_Name())
...
function Debug_Print_Score_Vals()
	for pid, player in pairs(PlayerTable) do
		...
		GameScoringMessage("Tactical %s:%s, Mill_Eff:%f, Kill_Eff:%f, Score:%f", player.Get_Name(), player.Get_Faction_Name(), mill_eff, kill_eff, score)
	end
	...
	for pid, player in pairs(PlayerTable) do
		...
		GameScoringMessage("Galactic %s:%s, Mill_Eff:%f, Kill_Eff:%f, Conq_eff:%f, Score:%f", player.Get_Name(), player.Get_Faction_Name(), mill_eff, kill_eff, conq_eff, score)
	end
end
