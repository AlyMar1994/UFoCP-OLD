...
1). Set Forces of Corruption's .EXE files (runme2.exe, StarWarsG.exe, swfoc.exe) as administrator.
...
==> Updates
================
See "_Changelog.txt" and "_MasterTEXT Changelog.txt" for changes per-update, in UFoCP's base directory.
